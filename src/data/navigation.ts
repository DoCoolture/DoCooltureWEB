export async function getNavigation(): Promise<TNavigationItem[]> {
  return [
    ...
    // OCULTO - Mega menu de demo de Chisfis
    // {
    //   id: '5',
    //   href: '/',
    //   name: 'Templates',
    ...
    //       name: 'Home Page',
    //       children: [
    //         { id: '1-1', href: '/', name: 'Stays' },
    //         { id: '1-2', href: '/real-estate', name: 'Real Estate' },
    ...
    // OCULTO - Dropdown Travelers original
    // {
    //   id: '6',
    //   href: '/',
    //   name: 'Travelers',
...
export const getLanguages = async () => {
  return [
    { id: 'English', name: 'English', description: 'United State', href: '#', active: true },
