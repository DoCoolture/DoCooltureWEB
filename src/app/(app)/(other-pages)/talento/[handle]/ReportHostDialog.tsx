...
export default function ReportHostDialog({ hostId, hostName }: Props) {
  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-x-2 text-sm text-neutral-700 dark:text-neutral-300 hover:text-red-600 dark:hover:text-red-400 transition-colors"
      >
        <HugeiconsIcon icon={Flag03Icon} size={16} color="currentColor" strokeWidth={1.5} />
        <span>Reportar este anfitrión</span>
      </button>
        ...
        <DialogBody>
          {done ? (
            <div className="py-4 text-center">
              <p className="text-green-600 font-medium">✅ Reporte enviado correctamente.</p>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex justify-end gap-2 pt-1">
                <button
                  onClick={handleClose}
                  className="rounded-xl border border-neutral-200 px-4 py-2 text-sm dark:border-neutral-700"
                >
                  Cancelar
                </button>
                <button
