...
function PasswordSection() {
  ...
  return (
    <div className="mt-16">
      <h2 className="text-3xl font-semibold">{t.accountPage['Update your password']}</h2>
      <Divider className="my-8 w-14!" />

      <form onSubmit={handleSubmit} className="max-w-xl space-y-6">
        <Field>
          <Label>{t.accountPage['Current password']}</Label>
          <Input type="password" className="mt-1.5" value={current} onChange={(e) => setCurrent(e.target.value)} required />
        </Field>
        <Field>
          <Label>{t.accountPage['New password']}</Label>
          <Input type="password" className="mt-1.5" value={newPass} onChange={(e) => setNewPass(e.target.value)} required />
        </Field>
        <Field>
          <Label>{t.accountPage['Confirm password']}</Label>
          <Input type="password" className="mt-1.5" value={confirm} onChange={(e) => setConfirm(e.target.value)} required />
        </Field>
