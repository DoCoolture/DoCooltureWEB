...
import { HotAirBalloonIcon, UserGroupIcon } from '@hugeicons/core-free-icons'
...
const solutions = [
  ...
  {
    name: 'Anfitriones',
    description: 'Conoce a los guías y expertos locales de DoCoolture',
    href: '/talento',
    icon: UserGroupIcon,
  },
]
  ...
  return (
    <Popover className="group">
      <PopoverButton className="-m-2.5 flex items-center p-2.5 text-sm font-medium text-neutral-700 group-hover:text-neutral-950 focus:outline-hidden dark:text-neutral-300 dark:group-hover:text-neutral-100">
        {T['Header']['DropdownTravelers']['Travelers']}
